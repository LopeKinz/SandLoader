...
/** @typedef {'E_GAME_NOT_FOUND'|'E_ASAR_INVALID'|'E_ASAR_ENTRY_MISSING'|'E_HOST_ABI'|'E_PATCH_FAILED'|'E_PATCH_AMBIGUOUS'|'E_MANIFEST_INVALID'|'E_DEPENDENCY'|'E_MOD_LOAD'|'E_CONFIG'|'E_IO'|'E_UNKNOWN'} SmlnCode */
